...
extern void DMA_PORTx2BUFF_Init(DMA_CHn, void *SADDR, void *DADDR, PTXn_e, DMA_BYTEn, uint32 count, DMA_PORTx2BUFF_cfg);


extern void DMA_count_Init(DMA_CHn CHn, PTXn_e ptxn, uint32 count, DMA_PORTx2BUFF_cfg cfg);
